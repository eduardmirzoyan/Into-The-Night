...
half4 CombinedShapeLightShared(half4 color, half4 shadowColor, half4 mask, half2 lightingUV)
{
    if (color.a == 0.0)
        discard;
    ...
    finalOutput = _HDREmulationScale * (lerp(color, shadowColor, 1 - finalModulate) + finalAdditve);
#endif
